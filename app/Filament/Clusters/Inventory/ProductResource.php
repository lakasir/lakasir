...
use App\Filament\Clusters\Inventory\ProductResource\Pages;
use App\Filament\Clusters\Inventory\ProductResource\Traits\HasProductForm;
...
{
    use HasProductForm, HasSubNavigationPosition, HasTranslatableResource, HasUploadFileField;
